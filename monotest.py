...
C1 = DPM3D.Cell(x1=8,y1=8,z1=1,calA0=1.05,VertexRecursion=2,r0=1.3,Kv=0.7,Ka=1.5,Kb=0)
C2 = DPM3D.Cell(x1=0,y1=0,z1=1,calA0=1.05,VertexRecursion=2,r0=1.5,Kv=0.7,Ka=1.5,Kb=0)

T = DPM3D.Tissue([C1,C2]*6,0.35)
T.MonolayerDisperse()
